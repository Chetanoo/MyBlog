...
export type PostSnippetFragment = { __typename?: 'Post', createdAt: string, updatedAt: string, id: number, title: string, text: string, textSnippet: string, rating: number, creatorId: number, voteStatus?: number | null, creator: { __typename?: 'User', username: string, id: number, createdAt: string, updatedAt: string } } & { ' $fragmentName'?: 'PostSnippetFragment' };

export type CommonErrorFragment = { __typename?: 'FieldError', field: string, message: string } & { ' $fragmentName'?: 'CommonErrorFragment' };

export type CommonUserFragment = { __typename?: 'User', id: number, username: string, email: string, createdAt: string, updatedAt: string } & { ' $fragmentName'?: 'CommonUserFragment' };
...
export type CreatePostMutation = { __typename?: 'Mutation', createPost: { __typename?: 'Post', createdAt: string, updatedAt: string, id: number, title: string, text: string, rating: number, creatorId: number } };
...
export type PostQuery = { __typename?: 'Query', posts: { __typename?: 'PaginatedPosts', hasMore: boolean, posts: Array<(
      { __typename?: 'Post' }
